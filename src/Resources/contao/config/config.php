...
//$GLOBALS['ISO_HOOKS']['updateItemInCollection'][] = array('Bcs\Hooks\Hooks', 'updateCollectionQuantity');
//$GLOBALS['ISO_HOOKS']['copiedCollectionItems'][] = array('Bcs\Hooks\Hooks', 'mergeCollections');
